...
/*
	...
	public static void main(String arg[]) throws IOException{
		String excelPath = System.getProperty("user.dir") + "//src//test//resources//testdata//master.xlsx";
		System.out.println("excelPath: " + excelPath);
		ExcelReader dataTable = new ExcelReader(excelPath);

		//for(int colCount = 0 ; colCount < dataTable.getColumnCount("TestData"); colCount++)
			System.out.println(dataTable.getCellData("TestData", 1, 1));
	}
*/
}